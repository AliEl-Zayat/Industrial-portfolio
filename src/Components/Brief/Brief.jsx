    ...
    <section id="brief" className="py-5">
      <Container className="position-relative">
        <Row>
          ...
          <Fade cascade duration={700} direction="right" triggerOnce='true'>
            ...
            <p className="fw-semibold w-75 lh-base brief-text">
              ...
              <br />
              استقطب مصنع
              كاف كم من الفنيين و ذوي الخبرة في مجال الحجر و الرخام للخروج بأفضل
              المعايير و الجودة و الجمالية للمساهمة في النهضة العمرانية و
              الإبداعية في وطننا الغالي.
            </p>
          ...
          <Col lg="6" md="6" >
            ...
            <img src={briefImage} alt="briefImage" className="img-fluid rounded" />
            </Zoom>
            </div>
          </Col>
        </Row>
        ...
        <div className="floatin-numbers d-flex gap-5">
          ...
          <div className="floated-number-wrapper">
            <p className="number"><CountUp delay={3} end={43} /></p>
            <p>
            عام من الخبرة
            </p>
          </div>
            <span className="vhr"></span>
          <div className="floated-number-wrapper">
            <p className="number"><CountUp delay={3} end={2640} /></p>
            <p>
            تصميم
            </p>
          </div>
            <span className="vhr"></span>
          <div className="floated-number-wrapper">
            <p className="number"><CountUp delay={3} end={1500} /></p>
            <p>
            عميل
            </p>
          </div>
