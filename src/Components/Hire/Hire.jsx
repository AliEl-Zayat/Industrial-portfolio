          ...
          <Col lg="6">
            <div className="bla-slogan">
              ...
              <p className="hiring-text">
                ...
                الحجر و الزخرفة بالمدينة الصناعية الثانية بالرياض . استقطب مصنع
                كاف كم من الفنيين و ذوي الخبرة في مجال الحجر و الرخام للخروج
                بأفضل المعايير و الجودة و الجمالية للمساهمة في النهضة العمرانية
                و الإبداعية في وطننا الغالي.
              </p>
            </div>
            <HireModal />
